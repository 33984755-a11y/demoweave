...
```bash
npx skills add 33984755-a11y/demoweave
```

或手动克隆进 Claude Code 的 skills 目录：

```bash
git clone https://github.com/33984755-a11y/demoweave.git ~/.claude/skills/demoweave
```
...
[MIT](LICENSE) © [33984755-a11y](https://github.com/33984755-a11y)
